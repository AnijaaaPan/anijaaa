                        ...
                        return (
                            ...
                            function () {
                                var d,
                                    ...
                                    m = Array.prototype.slice.apply(arguments, [
                                        t.length,
                                    ]);
                                return (
                ...
                function (t, e, n) {
                    var r = n(93),
                        ...
                        o = new (n(105))(function (t) {
                            (!(function (t) {
                                return (
                                    1 === t.length && i.canFlushOneItem(t[0])
                                );
                            })(t)
                                ? function (t) {
                                      r.init(),
                    ...
                    t.exports = function (t) {
                        t.params({ screenName: {}, userId: {}, url: {} }),
                            t.overrideProperty("id", {
                                get: function () {
                                    var t =
                                        s(this.params) || this.params.userId;
                                    return o + t;
                                },
                            }),
                            t.before("initialize", function () {
                                ...
                                d.isSupported() ||
                                    (r = (function (t) {
                                        return t.reduce(function (t, e) {
                                            return u.aug(
                                                t,
                                                f(e.contentDocument.defaultView)
                                            );
                                        }, {});
                                    })(t)),
                                (n = u.aug({}, e, r)),
